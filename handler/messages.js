      ...
      if (msg.message) {
        ...
        if (msg.message && msgTxt) {
          ...
          if (regexInfo.test(msgTxt)) {
            ...
            logging("info", `Get Message`, msgTxt);
            try {
              const templateText = `*AkmalVIP ヅ* | Group info\n\n*Group Name :* ${
          ...
          if (dropUser.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: "*AkmalVIP ヅ* | Drop Database Users\n\n*Baik _Tunggu Sebentart_*",
                  mentions: ["6281223720214@s.whatsapp.net"],
                },
                { quoted: msg }
              );
          ...
          if (dropContact.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: "*AkmalVIP ヅ* | Drop Database Contacts\n\n*Baik _Tunggu Sebentart_*",
                  mentions: ["6281223720214@s.whatsapp.net"],
                },
                { quoted: msg }
              );
